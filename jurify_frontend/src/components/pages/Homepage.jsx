...
export default function HomePage() {
  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col bg-gray-50 overflow-x-hidden font-sans">
      {/* Header / Navbar */}
          ...
          <div className="flex items-center justify-between h-20">
            ...
            <div className="hidden md:flex items-center space-x-8">
              <button
                ...
                className="relative flex items-center gap-2 text-gray-600 hover:text-[#11676a] transition-colors group"
              >
                <FaHome /> Home
            ...
            <div className="md:hidden">
              <button
                ...
                className="text-gray-600 hover:text-[#11676a] focus:outline-none"
              >
        ...
        {mobileOpen && (
          <div className="md:hidden bg-white border-t border-gray-200 shadow-lg">
            <div className="flex flex-col space-y-2 p-4">
              <button onClick={() => { window.scrollTo({ top: 0, behavior: "smooth" }); setMobileOpen(false); }} className="text-left text-gray-600 hover:text-[#11676a]">Home</button>
              <button onClick={() => scrollToSection('about')} className="text-left text-gray-600 hover:text-[#11676a]">About Us</button>
              <button onClick={() => scrollToSection('services')} className="text-left text-gray-600 hover:text-[#11676a]">Services</button>
              <Link to="/contact-us" className="text-gray-600 hover:text-[#11676a]">Contact</Link>
            </div>
          </div>
        )}
      </nav>
      ...
      <main className="flex-1">
              ...
              <div className="relative">
                ...
                {registerOpen && (
                  <div className="absolute mt-2 w-48 bg-white border border-gray-200 rounded-lg shadow-lg"
                    ...
                    <Link
                      to="/register-citizen"
                      className="flex items-center gap-x-2 p-3 rounded-lg border border-gray-200 hover:bg-[#e6f4f1] transition-colors"
        ...
        <section className="bg-gray-50 py-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 p-4 pt-0">
            {/* Card 1 */}
            <div className="relative flex flex-col gap-3 border rounded-xl p-6 bg-white border-gray-100 hover:translate-y-1 hover:shadow-lg transition-transform duration-300 group">
              ...
              <div>
                <h3 className="text-gray-900 text-base font-bold">Submit Case</h3>
            ...
            <div className="relative flex flex-col gap-3 border rounded-xl p-6 bg-white border-gray-100 hover:translate-y-1 hover:shadow-lg transition-transform duration-300 group">
              ...
              <div>
                <h3 className="text-gray-900 text-base font-bold">Get Matched</h3>
                <p className="text-slate-500 text-sm">
            ...
            <div className="relative flex flex-col gap-3 border rounded-xl p-6 bg-white border-gray-100 hover:translate-y-1 hover:shadow-lg transition-transform duration-300 group">
              ...
              <div>
                <h3 className="text-gray-900 text-base font-bold">Secure Chat & Scheduling</h3>
                <p className="text-slate-500 text-sm">
            ...
            <div className="relative flex flex-col gap-3 border rounded-xl p-6 bg-white border-gray-100 hover:translate-y-1 hover:shadow-lg transition-transform duration-300 group">
              ...
              <div>
                <h3 className="text-gray-900 text-base font-bold">Track Impact</h3>
                <p className="text-slate-500 text-sm">
        ...
        <section id="services" className="bg-gray-50 py-16 px-6 border-t border-gray-200">
          <div className="max-w-screen-xl mx-auto text-center">
            {/* Heading */}
            <h2 className="text-[#11676a] text-4xl sm:text-5xl font-extrabold mb-6">Our Services</h2>
        ...
        <section id="about" className="bg-white py-16 px-6 border-t border-gray-200">
          <div className="max-w-screen-xl mx-auto text-center">
            {/* Heading */}
            <h2 className="text-[#11676a] text-4xl sm:text-5xl font-extrabold mb-6">About Us</h2>
            <p className="text-gray-700 text-lg max-w-3xl mx-auto mb-12">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="p-6 bg-gray-50 rounded-xl shadow-md hover:shadow-xl transition transform hover:-translate-y-1">
        ...
        <section className="bg-gray-50 py-8 border-t border-gray-200">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 p-4 pt-0">
            {/* Card 1 */}
            <div className="flex flex-col gap-3 border rounded-xl p-6 bg-white border-gray-100 hover:translate-y-1 hover:shadow-lg transition-transform duration-300 group">
