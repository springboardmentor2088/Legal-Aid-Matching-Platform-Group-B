...
const CitizenDashboard = () => {
    ...
    return (
      ...
      `}</style>
            ...
            {/* --- SIDEBAR --- */}
            <aside
                className={`fixed inset-y-0 left-0 z-50 w-64 bg-primary text-white transform transition-transform duration-300 ease-in-auto overflow-y-auto scrollbar-hide ${sidebarOpen ? "translate-x-0" : "-translate-x-full"
            ...
            >
                <div className="flex flex-col h-full">
                    ...
                    {/* User Info */}
                    <div className="p-6 border-b border-primary-dark shrink-0">
                ...
                <div className="p-4 border-t border-primary-dark shrink-0">
                    <button
            ...
            <div className="flex-1 flex flex-col min-h-screen overflow-hidden lg:ml-64">
                ...
                <div className="flex-1 overflow-y-auto p-4 md:p-6 lg:p-8">
                    ...
                    {activeTab === "cases" && (
                        <MyCases onNewCase={() => setActiveTab("submit-case")} />
                    )}
                    {activeTab === "overview" && (
                        <div className="space-y-6">
                            {/* Welcome Banner */}
                            <div className="bg-linear-to-r from-primary to-primary-dark rounded-2xl p-6 md:p-8 text-white shadow-lg">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                                {[
                                    ...
                                    <div
                                        key={i}
                                        className="bg-white p-4 rounded-xl shadow-sm border border-gray-100 flex items-center gap-3 md:gap-4"
                                    >
                                        <div
                    ...
                    {activeTab === "profile" && (
                        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                            <div className="w-full max-w-6xl bg-white rounded-2xl shadow-md border border-gray-100 overflow-hidden">
                                {/* HEADER */}
                                <div className="bg-emerald-50 px-6 py-4 border-b border-emerald-100 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                                            ...
                                            <div className="space-y-1.5">
                                                ...
                                                <input
                                                    ...
                                                    value={profile?.email || ""}
                                                    disabled
                                                    className="w-full text-sm px-3 py-2.5 rounded-lg bg-gray-50 border border-gray-200 text-gray-500 cursor-not-allowed shadow-sm"
                                                />
                                            </div>
